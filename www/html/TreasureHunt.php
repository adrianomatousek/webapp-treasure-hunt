...
<body>
  ...
  <div id="topNavBar">
    <ul class="z-depth-1">
      ...
      <!-- Change route button -->
      <li>
      <select id="route-select" class="browser-default">
  ...
  <div class="modcontainer">
    <div id="modal" class="modal">
      <div class="modal-content">
        ...
        <img style="text-align: center; padding: 5px; width: 150px;" src="https://d1nhio0ox7pgb.cloudfront.net/_img/g_collection_png/standard/512x512/trophy.png" alt=""></img>
      </div>
